...
<div id='preview' style="display:none">
				...
				<div id="buttons">
				  <div class="buttonPane">
					...
					<div class="buttonPane" style="display:none">
					  ...
					  <p id="uploadButton" class="btn2" style="float:left;margin-left:75px;width:50px;" onclick="hapus_photo();pages('guru_photo.php?id=<?php echo $id?>&aksi=<?php echo $aksi?>');">Ambil</p>
					</div>
			...
			<div id="progres">
			<div id="progres_data_b"  style="cursor:pointer"  onClick="pages('guru_edit.php?id=<?php echo $id;?>')">Identitas</div><div id="progres_panah_b"></div>
			...
			<table id="form">
			  ...
			  <td></td>
			  <td>
				<p style=" font-size:25px; color:#CB150C; margin:-4px 0px 0px 0px; width:10px; position:absolute">*</p>&nbsp;&nbsp;&nbsp;Sertakan Photo Guru</td>
			  </tr>
			  <tr>
			  <td></td>
			  <td>
            ...
            <img src="../style/image/loader.gif" width="130px" height="16px" id="loader" style="position:absolute;display:none;">
				  ...
				  <input type='button' value='Selesai' class="btn2" onclick="hapus_photo();pages('guru.php');" id="kembali" style=" margin-top:20px; "/>     
				</td>
			  </tr>
			</table>