...
$(document).ready(function(){
	$("#formtambah").submit(function(event){
		...
		$.ajax({
			url: "siswa_jurusan_edit.php?"+data,
...
<table id="form">
  <tr>
	...
	{ if($arr1['0']==$arr_edit['1']){echo "<option value='$arr1[0]' selected>$arr1[2]</option>";}else{echo "<option value='$arr1[0]'>$arr1[2]</option>";}}
	?>
    </select>
  ...
  <td>
	...
	{ if($tgl<10){$tgl="0".$tgl;}; if($tgl==substr($arr_edit['tgl_masuk'],0,2)){echo "<option value='$tgl' selected>$tgl</option>";}else{echo "<option value='$tgl'>$tgl</option>";}}
	?>
    </select>
	...
	{
		if($bln<10){$bln="0".$bln;};
		if($bln==substr($arr_edit['tgl_masuk'],3,2)){echo "<option value='$bln' selected>".bulan($bln)."</option>";}else{echo "<option value='$bln'>".bulan($bln)."</option>";}
	}
	?>
    </select>
    ...
    <option value=""></option>
    <?php
    for($th=2001;$th<=2020;$th++)
	{ if($th==substr($arr_edit['tgl_masuk'],6,4)){echo "<option value='$th' selected>$th</option>";}else{echo "<option value='$th'>$th</option>";}}
	?>
    </select>
    </td>
   </tr>
   <tr>
    <td>&nbsp;</td>
      ...
      <input type='button' id='kem' value='Kembali' class="btn2" onclick="pg('siswa_wali_edit.php?id=<?php echo $id;?>');"/> 
      <input type='button' id='lanjut' value='Lewati' class="btn2"  onclick="pg('siswa_photo.php?id=<?php echo $id;?>');"/> 
    </td>
  </tr>
</table>
</form>
