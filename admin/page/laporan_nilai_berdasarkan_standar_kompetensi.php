...
?>
<div id="tit_page" onclick="pages('laporan.php');" style="cursor:pointer">Laporan Nilai Berdasarkan Standar Kompetensi</div>
<?php
if(isset($_GET['kelas']))
{?>
<a href="laporan_nilai_berdasarkan_standar_kompetensi_cetak_csv.php?tahun=<?php echo $_GET['tahun'];?>&keahlian=<?php echo $_GET['keahlian'];?>&semester=<?php echo $_GET['semester'];?>&kelas=<?php echo $_GET['kelas'];?>&standar=<?php echo $_GET['standar']?>" id="cetak_csv"></a>
<div onclick="pg('laporan_nilai_berdasarkan_standar_kompetensi_cetak_pdf.php?tahun=<?php echo $_GET['tahun'];?>&keahlian=<?php echo $_GET['keahlian'];?>&semester=<?php echo $_GET['semester'];?>&kelas=<?php echo $_GET['kelas'];?>&standar=<?php echo $_GET['standar']?>');" id="cetak_pdf"></div>
<?php
}
else
{?>
...
<tr>
	...
	<td>
    <select name="tahun" required id="select" onchange="pg('laporan_nilai_berdasarkan_standar_kompetensi.php?tahun='+this.value);">
    <option value=""></option>
    <?php
    $qry1=que("
...
<tr>
	...
	<td>
    <select name="keahlian" required id="select" onchange="pg('laporan_nilai_berdasarkan_standar_kompetensi.php?tahun=<?php echo $_GET['tahun'];?>&keahlian='+this.value);">
    <?php
...
<tr>
	...
	<td>
    <select name="semester" required id="select" onchange="pg('laporan_nilai_berdasarkan_standar_kompetensi.php?tahun=<?php echo $_GET['tahun'];?>&keahlian=<?php echo $_GET['keahlian'];?>&semester='+this.value);">
    <?php
...
<tr>
	...
	<td>
    <select name="standar" required id="select" onchange="pg('laporan_nilai_berdasarkan_standar_kompetensi.php?tahun=<?php echo $_GET['tahun'];?>&keahlian=<?php echo $_GET['keahlian'];?>&semester=<?php echo $_GET['semester'];?>&standar='+this.value);">
    <?php
...
<tr>
	...
	<td>
    <select name="kelas" required id="select" onchange="pg('laporan_nilai_berdasarkan_standar_kompetensi.php?tahun=<?php echo $_GET['tahun'];?>&keahlian=<?php echo $_GET['keahlian'];?>&standar=<?php echo $_GET['standar'];?>&semester=<?php echo $_GET['semester'];?>&kelas='+this.value);">
    <?php
