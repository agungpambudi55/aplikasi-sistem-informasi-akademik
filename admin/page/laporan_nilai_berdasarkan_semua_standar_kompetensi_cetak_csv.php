...
header('Content-Disposition: attachment; filename=laporan_nilai_berdasarkan_siswa.xls');
$qry=que("select 
tb_siswa.nama, 
tb_siswa.nis, 
...
while($arr=mysql_fetch_array($qry))
{
  ...
  <tr>
    ...
    <td style='vertical-align:middle' align='center'>$arr[6]</td>
    <td>$arr[7]</td>
    <td style='vertical-align:middle' align='center'>$arr[8]</td>
